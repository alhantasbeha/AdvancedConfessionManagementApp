        ...
        <div className="h-[73px] p-4 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 flex items-center justify-between relative overflow-hidden">
          ...
          <div className="flex items-center gap-2 relative z-10">
            ...
            <button 
              ...
              className="hidden md:flex items-center justify-center p-2 rounded-lg bg-white/20 hover:bg-white/30 transition-all duration-200 border border-white/30 backdrop-blur-sm group"
              title={isCollapsed ? 'توسيع الشريط الجانبي' : 'طي الشريط الجانبي'}
            >
              {isCollapsed ? (
                // Double Right Chevron (≫) or Hamburger when collapsed
                <div className="flex items-center">
                  <Icon name="arrowLeft" className="w-4 h-4 text-white group-hover:scale-110 transition-transform" />
                  <Icon name="arrowLeft" className="w-4 h-4 text-white -ml-1 group-hover:scale-110 transition-transform" />
                </div>
              ) : (
                // Double Left Chevron (≪) when expanded
                <div className="flex items-center">
                  <Icon name="arrowRight" className="w-4 h-4 text-white group-hover:scale-110 transition-transform" />
                  <Icon name="arrowRight" className="w-4 h-4 text-white -ml-1 group-hover:scale-110 transition-transform" />
                </div>
              )}
            </button>
