          ...
          <table className="min-w-full text-right">
            <thead>
              <tr className="border-b dark:border-gray-700">
                ...
                <th className="p-2 sm:p-3 text-xs sm:text-sm hidden sm:table-cell whitespace-nowrap">العلامات</th>
                <th className="p-2 sm:p-3 text-xs sm:text-sm hidden md:table-cell whitespace-nowrap">ملاحظات</th>
            ...
            <tbody>
              {paginatedLogs.map(log => (
                <tr key={log.id} className="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                  <td className="p-2 sm:p-3 font-semibold text-xs sm:text-sm min-w-0">
                  ...
                  <td className="p-2 sm:p-3 hidden sm:table-cell min-w-0">
                    <div className="flex flex-wrap gap-1">
      ...
      <div className="bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-xl shadow-md w-full min-w-0">
        ...
        <div className="flex flex-col gap-4 mb-6 w-full min-w-0">
          ...
          <div className={`${showFilters ? 'block' : 'hidden'} sm:block w-full min-w-0`}>
            <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg space-y-4 w-full min-w-0">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 w-full">
                {/* Confessor Filter */}
                <select 
                  value={selectedConfessor}
                  onChange={(e) => setSelectedConfessor(e.target.value)}
                  className="p-2 rounded-lg border dark:bg-gray-600 dark:border-gray-500 text-sm w-full"
                >
                ...
                <input 
                  ...
                  className="p-2 rounded-lg border dark:bg-gray-600 dark:border-gray-500 dark:[color-scheme:dark] text-sm w-full"
                />
